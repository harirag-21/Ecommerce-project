    ...
    <div>
      <>
           <div className='flex mt-[180px] justify-center'>
                  ...
                  <div><input type='email' className=' w-[350px] h-[40px] border-2 border-black' name='text' placeholder='Email'/></div>
                  <div><input type='password' className=' w-[350px] h-[40px] border-2 border-black' name='text' placeholder='Password'/></div>
